...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        LT(FN, KC_TAB),        KC_Q,     KC_W,     KC_E,    KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,      KC_P,     KC_LBRC,  KC_RBRC,  XXXXXXX,  XXXXXXX,
        KC_LEFT_CTRL,             KC_A,     KC_S,     KC_D,    KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,  KC_QUOT,  XXXXXXX,   XXXXXXX,
        KC_LEFT_SHIFT,  KC_Z,     KC_X,     KC_C,    KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,  KC_RSFT,  KC_UP,
        TG(FN),             KC_LOPT,  KC_LCMD,  KC_SPC,  KC_CAPS_LOCK,  TG(MAC_BASE),  TG(MEDIA), KC_LEFT,  KC_DOWN,  KC_RIGHT),
    ...
    [FN] = LAYOUT_ansi_67(
        ...
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,     XXXXXXX,       XXXXXXX,  XXXXXXX,  KC_BSPC,  KC_ENT,  XXXXXXX,   KC_PRINT_SCREEN,  XXXXXXX,  XXXXXXX,  KC_DEL,   XXXXXXX,
    ...
    [MEDIA] = LAYOUT_ansi_67(
        ...
        _______,          XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  TG(MEDIA),  XXXXXXX,  XXXXXXX,  XXXXXXX),
};
