...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        TG(_FN1), KC_LOPT,  KC_LCMD,                             KC_SPC,                            MO(_FN1), KC_ROPT,  KC_CAPS,  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,            KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        TG(_FN1), KC_LWIN,  KC_LALT,                             KC_SPC,                             MO(_FN1),  KC_RWIN, KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT),
