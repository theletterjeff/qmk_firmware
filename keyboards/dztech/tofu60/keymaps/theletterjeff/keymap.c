...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_all(
        ...
        CTL_TG_FN,             KC_A,     KC_S,     KC_D,    KC_F,     KC_G,     KC_H,     KC_J,    KC_K,  KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,
        LSFT_T(KC_CAPS_LOCK),  KC_NUBS,  KC_Z,     KC_X,    KC_C,     KC_V,     KC_B,     KC_N,    KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  TG(MAC_BASE),
        TG(MEDIA),             KC_LWIN,  KC_LALT,  KC_SPC,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX
    ),
    [MAC_BASE] = LAYOUT_all(
    ...
    [FN] = LAYOUT_all(
        ...
        _______,  XXXXXXX,  XXXXXXX,  KC_HOME,     KC_END,        XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PAGE_UP,  KC_PAGE_DOWN,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
